...
./target/release/libcall --output yaml -lm sqrt 25.0 :f64
echo

echo "4. YAML output with callback (qsort):"
./target/release/libcall --output yaml -lc qsort '@3i32:3,1,2' 'usize:3' 'usize:4' "'i32(ptr a, ptr b){ return i32(a) - i32(b) }'" :void
echo

echo "5. JSON output with callback:"
./target/release/libcall --output json -lc qsort '@3i32:3,1,2' 'usize:3' 'usize:4' "'i32(ptr a, ptr b){ return i32(a) - i32(b) }'" :void
echo
